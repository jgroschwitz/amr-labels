### copied by Jonas Groschwitz from the am-parser github (from graph_dependency_parser/am_algebra) because
### Jonas does not know how dependencies work in Python (is there jitpack for python?)
